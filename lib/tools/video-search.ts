              ...
              batch.map(
                async (
                  ...
                  try {
                    ...
                    const [detailsResult, captionsResult, timestampsResult] =
                    ...
                    const processedVideo = {
                      ...
                      details:
                        detailsResult.status === 'fulfilled'
                          ...
                          : undefined,
                      captions:
                        captionsResult.status === 'fulfilled'
                          ? captionsResult.value || undefined
                          : undefined,
                      timestamps:
                        timestampsResult.status === 'fulfilled'
                          ? timestampsResult.value
                          : undefined
                    }
                    ...
                    console.warn(
                      `⚠️  Error processing video ${videoId}:`,
                      error
                    )
                    return baseResult
                  }
...
export const videoSearchTool = createVideoSearchTool(
